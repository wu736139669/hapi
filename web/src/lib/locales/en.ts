export default {
  ...
  'session.action.pinPersonal': 'Mark as my session',
  'session.action.unpinPersonal': 'Remove my session mark',
  'session.action.pinFailed': 'Could not update pin',
  'sessions.personalPinnedSection': 'My sessions',
  ...
  'runner.skew.teamUnsupported': 'NO AGENT TEAM',
  ...
  'newSession.agentUnavailable': 'No agents are available on the selected machine.',
  'newSession.agentUnavailableOnMachine': 'This agent is not available on the selected machine.',
  ...
  'file.page.htmlPreviewBackToHapi': 'Back to HAPI',
  ...
  'toolGroup.executionProcess.title': 'Execution process',
  'toolGroup.executionProcess.expand': 'Expand execution process',
  'toolGroup.executionProcess.collapse': 'Collapse execution process',
  ...
  'settings.general.showUnavailableAgents': 'Show unavailable agents',
  'settings.general.showUnavailableAgents.desc': 'Show agent types whose CLI is not installed or configured on the selected machine. Off by default.',
  ...
  'settings.display.sessionToolbar.collapsed': 'Collapse toolbar by default',
  'settings.display.sessionToolbar.collapsed.desc': 'Hide the less-used search, date, unread, and share buttons. Device filter, settings, and new session stay visible; use the arrow to expand.',
  'settings.display.sessionToolbar.search': 'Show search button',
  'settings.display.sessionToolbar.search.desc': 'Show the session search entry in the toolbar.',
  'settings.display.sessionToolbar.dateFilter': 'Show date filter',
  'settings.display.sessionToolbar.dateFilter.desc': 'Show the session date filter in the toolbar.',
  'settings.display.sessionToolbar.unreadFilter': 'Show unread filter',
  'settings.display.sessionToolbar.unreadFilter.desc': 'Show the unread-session filter in the toolbar.',
  'settings.display.sessionToolbar.share': 'Show share management',
  'settings.display.sessionToolbar.share.desc': 'Show the active share management entry in the toolbar.',
  'settings.display.sessionToolbar.browse': 'Show workspace browser',
  'settings.display.sessionToolbar.browse.desc': 'Show the workspace browser when a machine exposes workspace roots.',
  ...
  'settings.chat.executionProcessEnabled': 'Group activity into the execution process',
  'settings.chat.executionProcessEnabled.desc': 'Keep reasoning, tool activity, and intermediate output in a compact, scrollable execution process panel. Turn off to show them inline.',
  ...
  'session.action.sessionShare': 'Collaborative share',
  'sessionShare.manage': 'Share management',
  'sessionShare.manageTitle': 'Active session shares',
  'sessionShare.manageDescription': 'All shares that have not been revoked are listed here. Shares do not expire automatically.',
  'sessionShare.manageLoading': 'Loading shares…',
  'sessionShare.manageEmpty': 'There are no active session shares.',
  'sessionShare.active': 'Active',
  'sessionShare.activeShort': 'Shared',
  'sessionShare.noExpiry': 'No automatic expiry',
  'sessionShare.createdAt': 'Created {time}',
  'sessionShare.regenerate': 'Regenerate',
  'sessionShare.regenerating': 'Generating…',
  'sessionShare.regenerateConfirm': 'Regenerating will immediately invalidate the previous share link and access code. Continue?',
  'sessionShare.revoking': 'Revoking…',
  'sessionShare.title': 'Collaborative session share',
  ...
  'sessionShare.revoked': 'The collaborative share is no longer accessible.',
  'sessionShare.revokeFailed': 'Could not revoke collaborative share',
  'sessionShare.join': 'Join shared session',
  'sessionShare.joinDescription': 'Enter the 6-digit access code provided by the owner to use this session.',
  'sessionShare.enterCode': 'Access code',
  ...
  'team.section.title': 'Teams',
  'team.section.archived': 'archived',
  'team.title': 'Team',
  'team.badge': 'Team',
  'team.back': 'Back',
  'team.loading': 'Loading team…',
  'team.empty': 'No team messages yet.',
  'team.tasks.progress': '{done}/{total} tasks done',
  'team.filter.timeline': 'Timeline',
  'team.filter.requirements': 'By requirement',
  'team.filter.key': 'Key only',
  'team.filter.task': 'Task',
  'team.filter.taskPlaceholder': 'Pick a task…',
  'team.thread.count': '{n} messages',
  'team.jumpToLatest': 'Jump to latest',
  'team.send.requirement': 'Requirement',
  'team.send.requirementAuto': 'Auto-file',
  'team.send.requirementNew': 'As new requirement',
  'team.requirement.other': 'Other',
  'team.requirement.original': 'Original ask',
  'team.requirement.yourAsk': 'Your ask',
  'team.requirement.result': 'Result',
  'team.requirement.resultTasks': '{done}/{total} tasks done',
  'team.requirement.resultProgress': 'In progress · {done}/{total} tasks',
  'team.requirement.deliverable': 'Deliverable',
  'team.requirement.milestones': 'Key milestones',
  'team.requirement.allProcess': 'Full process',
  'team.requirement.showAll': 'Show full process (+{n})',
  'team.requirement.showMilestones': 'Milestones only',
  'team.requirement.tasks': 'Tasks {done}/{total}',
  'team.requirement.addNote': 'Add a note',
  'team.requirement.messages': '{n} messages',
  'team.requirement.conclusion': 'Result',
  'team.requirement.status.open': 'Open',
  'team.requirement.status.doing': 'In progress',
  'team.requirement.status.done': 'Done',
  'team.requirement.status.blocked': 'Blocked',
  'team.thread.expand': 'Expand',
  'team.thread.collapse': 'Collapse',
  'team.message.you': 'You',
  'team.message.all': 'all',
  'team.message.taskAssign': 'Task assignment',
  'team.message.decision': 'Needs your decision',
  'team.send.failed': 'Failed to send',
  'team.reply.pending': 'Needs your reply',
  'team.reply.replied': 'Replied',
  'team.reply.dismissed': 'Dismissed',
  'team.reply.button': 'Reply',
  'team.reply.cancel': 'Cancel reply',
  'team.reply.replyingTo': 'Replying to {role}',
  'team.pending.title': 'Needs you',
  'team.pending.dismiss': 'Dismiss',
  'team.pending.dismissFailed': 'Failed to dismiss',
  'team.send.toLead': 'Lead',
  'team.send.hint': 'Directed messages wake the member; broadcast stays in the log.',
  'team.send.placeholder': 'Message the team…',
  'team.send.button': 'Send',
  'team.status.working': 'working',
  'team.status.blocked': 'needs you',
  'team.status.offline': 'offline',
  'team.status.idle': 'idle',
  'team.panel.title': 'Team panel',
  'team.panel.toggle': 'Team panel',
  'team.panel.close': 'Close panel',
  'team.panel.members': 'Members',
  'team.panel.tasks': 'Task board',
  'team.panel.todo': 'To do',
  'team.panel.doing': 'In progress',
  ...
  'team.panel.budget.messages': 'Messages {n}/min',
  'team.panel.budget.chain': 'Chain depth {n}',
  'settings.general.teamsEnabled': 'Agent Teams',
  'settings.general.teamsEnabled.restartDesc': 'Enable multi-agent team sessions (off by default). Requires a hub restart to take effect.',
  'settings.general.teamsEnabled.activeDesc': 'Agent Teams are active. Team tools, group chat and task board are available.',
  'team.create.name': 'Team name',
  'team.add.title': 'Add member',
  'team.memory.title': 'Memory',
  'team.memory.empty': 'No files yet (charter.md is created with the team).',
  'team.memory.loading': 'Loading…',
  'team.memory.failed': 'Failed to load file',
  'team.task.add': 'Add',
  'team.task.newPlaceholder': 'New task title…',
  'team.task.save': 'Save',
  'team.task.saving': 'Saving…',
  'team.task.status': 'Status',
  'team.task.assignee': 'Assignee',
  'team.task.viewTimeline': 'View timeline',
  'team.task.createFailed': 'Failed to create task',
  'team.task.statusLabel.todo': 'To do',
  'team.task.statusLabel.doing': 'In progress',
  'team.task.statusLabel.done': 'Done',
  'team.task.statusLabel.blocked': 'Blocked',
  'team.settings.title': 'Team settings',
  'team.settings.rename': 'Rename',
  'team.settings.archive': 'Archive team (stop message routing)',
  'team.settings.unarchive': 'Unarchive team',
  'team.settings.delete': 'Delete team…',
  'team.settings.deleteConfirm': 'Delete this team? Members/tasks/messages are removed; member sessions survive.',
  'team.settings.deleteConfirmYes': 'Delete',
  'team.archivedHint': 'This team is archived. Unarchive it in team settings to resume.',
  ...
  'team.settings.budget': 'Team budget',
  'team.settings.budget.members': 'Max members',
  'team.settings.budget.messages': 'Msgs/min',
  'team.settings.budget.chain': 'Chain depth',
  'team.settings.budgetHint': 'The member cap includes the lead; changes apply immediately.',
  'team.member.remove': 'Remove from team',
  'team.member.removeConfirm': 'Remove "{role}" from the team?',
  'team.member.removeStopSession': 'Also stop the session',
  'team.member.removeConfirmYes': 'Remove',
  'team.member.removeFailed': 'Failed to remove member',
  ...
  'newSession.team.machineUnsupported': 'This runner predates Agent Team. Upgrade the HAPI CLI on that machine (or pick another machine) before creating a team session.',
  'team.section.members': '{n} members',
  'team.section.noMembers': 'No members yet',
  'newSession.member.banner': 'Joining team "{name}" as a member',
  'newSession.member.role': 'Role name',
  'newSession.member.rolePlaceholder': 'e.g. Builder A / Reviewer',
  ...
  'team.memory.repoHint': 'Team memory lives with the code: <repo>/.hapi/teams/<team>/ (created when the lead session starts). Open it here or in the lead session files.',
} as const
