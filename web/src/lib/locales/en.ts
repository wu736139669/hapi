export default {
  ...
  'team.create.namePlaceholder': 'e.g. Refactor auth module',
  'team.create.lead': 'Lead session',
  'team.create.leadNone': 'No lead (add later)',
  'team.create.leadHint': 'Pick an existing session to lead the team. It can spawn members and assign tasks.',
  'team.create.noSessions': 'No sessions yet - create a session first.',
  'team.create.submit': 'Create team',
  'team.create.creating': 'Creating…',
  'team.add.title': 'Add member',
  'team.add.role': 'Role name',
  'team.add.rolePlaceholder': 'e.g. Builder A / Reviewer',
  'team.add.task': 'Task brief (optional)',
  'team.add.taskPlaceholder': 'What should this member do first?',
  'team.add.yolo': 'Autonomous mode (skip permission prompts)',
  'team.add.submit': 'Spawn member',
  'team.add.spawning': 'Spawning…',
  'team.add.noLead': 'This team has no lead session - set one before spawning members.',
  'team.add.success': 'Spawned {role}',
  ...
  'team.add.agent': 'Agent',
  'team.add.agentDefault': 'Follow the lead',
  'team.add.worktree': 'Isolated git worktree',
  'team.create.machine': 'Machine',
  'team.create.noMachines': 'No runner online',
  'team.create.agent': 'Agent',
  'team.create.directory': 'Directory',
  'team.create.directoryPlaceholder': '/Users/you/project',
  'team.create.directoryHint': 'The lead session starts here; members spawn on the same machine/directory unless you isolate them with a worktree.',
  'team.create.worktree': 'Isolated git worktree for the lead',
