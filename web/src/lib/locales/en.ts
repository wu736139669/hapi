export default {
  ...
  'codexSync.quick.title': 'Import from Codex',
  'codexSync.quick.description': 'Choose a local Codex session to import and open in Hapi.',
  'codexSync.quick.machine': 'Computer',
  'codexSync.quick.searchPlaceholder': 'Search Codex sessions',
  'codexSync.quick.notImported': 'Not imported',
  'codexSync.quick.imported': 'In Hapi',
  'codexSync.quick.empty': 'No Codex sessions were active in the last {hours} hours.',
  'codexSync.quick.noResults': 'No Codex sessions match this search.',
  'codexSync.quick.noMachines': 'No computer is online.',
  'codexSync.quick.loadMore': 'Load previous day',
  'codexSync.quick.loadingMore': 'Loading previous day…',
  'codexSync.quick.importAndOpen': 'Import and open',
  'codexSync.quick.syncAndOpen': 'Sync and open',
  'codexSync.quick.importing': 'Importing…',
  'codexSync.quick.missingSession': 'Hapi session ID missing from import response.',
  ...
  'queuedMessages.steerNow': 'Steer into active turn',
  ...
  'settings.codexQuickImport.title': 'Codex quick import',
  'settings.codexQuickImport.initialHours': 'Initial time range',
  'settings.codexQuickImport.initialHours.description': 'Scan sessions active within this many hours when the import dialog opens.',
  'settings.codexQuickImport.hoursUnit': 'hours',
  'settings.codexQuickImport.showLoadMore': 'Show load more',
  'settings.codexQuickImport.showLoadMore.description': 'Allow loading one earlier day at a time from the import dialog.',
