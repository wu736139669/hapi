export default {
  ...
  'codexSync.quick.title': '从 Codex 导入',
  'codexSync.quick.description': '选择一个本机 Codex 会话，导入后在 Hapi 中打开。',
  'codexSync.quick.machine': '电脑',
  'codexSync.quick.searchPlaceholder': '搜索 Codex 会话',
  'codexSync.quick.notImported': '未导入',
  'codexSync.quick.imported': '已在 Hapi',
  'codexSync.quick.empty': '最近 {hours} 小时内没有活跃的 Codex 会话。',
  'codexSync.quick.noResults': '没有符合搜索条件的 Codex 会话。',
  'codexSync.quick.noMachines': '当前没有在线电脑。',
  'codexSync.quick.loadMore': '加载更早 1 天',
  'codexSync.quick.loadingMore': '正在加载更早 1 天…',
  'codexSync.quick.importAndOpen': '导入并打开',
  'codexSync.quick.syncAndOpen': '同步并打开',
  'codexSync.quick.importing': '导入中…',
  'codexSync.quick.missingSession': '导入结果缺少 Hapi 会话 ID。',
  ...
  'queuedMessages.steerNow': '立即引导当前回合',
  'queuedMessages.steerFailed': '无法引导这条消息',
  'queuedMessages.steerAlreadyInvoked': '消息已经发出',
  ...
  'settings.codexQuickImport.title': 'Codex 快捷导入',
  'settings.codexQuickImport.initialHours': '初始时间范围',
  'settings.codexQuickImport.initialHours.description': '打开导入弹窗时，只扫描最近这段时间内活跃的会话。',
  'settings.codexQuickImport.hoursUnit': '小时',
  'settings.codexQuickImport.showLoadMore': '显示“加载更多”',
  'settings.codexQuickImport.showLoadMore.description': '允许在导入弹窗中每次向前加载 1 天。',
