export default {
  ...
  'session.action.pinPersonal': '标记为我的会话',
  'session.action.unpinPersonal': '取消我的会话标记',
  'session.action.pinFailed': '无法更新置顶状态',
  'sessions.personalPinnedSection': '我的会话',
  ...
  'runner.skew.teamUnsupported': '不支持团队',
  ...
  'newSession.agent': '代理',
  'newSession.agentUnavailable': '所选设备上没有可用的智能体。',
  'newSession.agentUnavailableOnMachine': '所选设备上没有可用的这个智能体。',
  'newSession.model': '模型',
  ...
  'toolGroup.executionProcess.title': '执行过程',
  'toolGroup.executionProcess.expand': '展开执行过程',
  'toolGroup.executionProcess.collapse': '收起执行过程',
  ...
  'settings.general.showUnavailableAgents': '显示不可用的智能体',
  'settings.general.showUnavailableAgents.desc': '显示所选设备上未安装或未正确配置 CLI 的智能体。默认关闭。',
  ...
  'settings.display.sessionToolbar.collapsed': '默认折叠工具栏',
  'settings.display.sessionToolbar.collapsed.desc': '隐藏不常用的搜索、日期、未读和分享按钮，只保留设备筛选、设置和新建会话；点击上下箭头可展开。',
  'settings.display.sessionToolbar.search': '显示搜索按钮',
  'settings.display.sessionToolbar.search.desc': '在会话列表顶部显示搜索入口。',
  'settings.display.sessionToolbar.dateFilter': '显示日期筛选',
  'settings.display.sessionToolbar.dateFilter.desc': '在会话列表顶部显示按日期筛选入口。',
  'settings.display.sessionToolbar.unreadFilter': '显示未读筛选',
  'settings.display.sessionToolbar.unreadFilter.desc': '在会话列表顶部显示未读会话筛选入口。',
  'settings.display.sessionToolbar.share': '显示分享管理',
  'settings.display.sessionToolbar.share.desc': '在会话列表顶部显示活跃分享管理入口。',
  'settings.display.sessionToolbar.browse': '显示工作区浏览',
  'settings.display.sessionToolbar.browse.desc': '有工作区权限时，在会话列表顶部显示浏览入口。',
  ...
  'settings.chat.executionProcessEnabled': '启用执行过程窗口',
  'settings.chat.executionProcessEnabled.desc': '将思考、工具活动和中间输出收进紧凑且可滚动的执行过程窗口；关闭后按原消息顺序直接展开显示。',
  ...
  'session.action.sessionShare': '会话协作分享',
  'sessionShare.manage': '分享管理',
  'sessionShare.manageTitle': '活跃的会话分享',
  'sessionShare.manageDescription': '这里显示所有尚未撤销的会话分享。分享不会自动过期。',
  'sessionShare.manageLoading': '正在加载分享…',
  'sessionShare.manageEmpty': '当前没有活跃的会话分享。',
  'sessionShare.active': '分享中',
  'sessionShare.activeShort': '已分享',
  'sessionShare.noExpiry': '不会自动过期',
  'sessionShare.createdAt': '创建于 {time}',
  'sessionShare.regenerate': '重新生成',
  'sessionShare.regenerating': '生成中…',
  'sessionShare.regenerateConfirm': '重新生成后，之前的分享链接和访问码会立即失效。确定继续吗？',
  'sessionShare.revoking': '撤销中…',
  'sessionShare.title': '会话协作分享',
  ...
  'sessionShare.revoked': '协作分享已失效。',
  'sessionShare.revokeFailed': '撤销协作分享失败',
  'sessionShare.join': '加入共享会话',
  'sessionShare.joinDescription': '输入分享者提供的 6 位访问码，即可操作这个会话。',
  'sessionShare.enterCode': '访问码',
  ...
  'team.section.title': '团队',
  'team.section.archived': '已归档',
  'team.title': '团队',
  'team.badge': '团队',
  'team.back': '返回',
  'team.loading': '正在加载团队…',
  'team.empty': '还没有团队消息。',
  'team.tasks.progress': '任务 {done}/{total} 完成',
  'team.filter.timeline': '时间线',
  'team.filter.requirements': '按需求',
  'team.filter.key': '只看关键',
  'team.filter.task': '任务',
  'team.filter.taskPlaceholder': '选择任务…',
  'team.thread.count': '{n} 条',
  'team.jumpToLatest': '跳到最新',
  'team.send.requirement': '归属需求',
  'team.send.requirementAuto': '自动归类',
  'team.send.requirementNew': '作为新需求',
  'team.requirement.other': '其他',
  'team.requirement.original': '需求原文',
  'team.requirement.yourAsk': '你的问题',
  'team.requirement.result': '结果',
  'team.requirement.resultTasks': '{done}/{total} 任务完成',
  'team.requirement.resultProgress': '进行中 · 任务 {done}/{total}',
  'team.requirement.deliverable': '交付物',
  'team.requirement.milestones': '关键节点',
  'team.requirement.allProcess': '全部过程',
  'team.requirement.showAll': '显示全部过程（+{n}）',
  'team.requirement.showMilestones': '只看关键节点',
  'team.requirement.tasks': '任务 {done}/{total}',
  'team.requirement.addNote': '补充说明',
  'team.requirement.messages': '{n} 条消息',
  'team.requirement.conclusion': '结论',
  'team.requirement.status.open': '待开始',
  'team.requirement.status.doing': '进行中',
  'team.requirement.status.done': '已完成',
  'team.requirement.status.blocked': '卡住',
  'team.thread.expand': '展开',
  'team.thread.collapse': '收起',
  'team.message.you': '你',
  'team.message.all': '全员',
  'team.message.taskAssign': '任务指派',
  'team.message.decision': '需要你决策',
  'team.send.failed': '发送失败',
  'team.reply.pending': '待你回复',
  'team.reply.replied': '已回复',
  'team.reply.dismissed': '已忽略',
  'team.reply.button': '回复',
  'team.reply.cancel': '取消回复',
  'team.reply.replyingTo': '回复 {role}',
  'team.pending.title': '待你确认',
  'team.pending.dismiss': '忽略',
  'team.pending.dismissFailed': '忽略失败',
  'team.send.toLead': 'Lead',
  'team.send.hint': '定向消息会唤醒成员；广播只进日志。',
  'team.send.placeholder': '给团队发消息…',
  'team.send.button': '发送',
  'team.status.working': '工作中',
  'team.status.blocked': '需要你',
  'team.status.offline': '离线',
  'team.status.idle': '空闲',
  'team.panel.title': '团队面板',
  'team.panel.toggle': '团队面板',
  'team.panel.close': '关闭面板',
  'team.panel.members': '成员',
  'team.panel.tasks': '任务板',
  'team.panel.todo': '待办',
  'team.panel.doing': '进行中',
  'team.panel.done': '完成',
  'team.panel.empty': '空',
  ...
  'team.panel.budget.messages': '消息 {n}/分钟',
  'team.panel.budget.chain': '链深 {n}',
  'settings.general.teamsEnabled': 'Agent 团队',
  'settings.general.teamsEnabled.restartDesc': '启用多 Agent 团队会话（默认关闭）。保存后需重启 hub 生效。',
  'settings.general.teamsEnabled.activeDesc': 'Agent 团队已生效：团队工具、群聊与任务板均可用。',
  'team.create.name': '团队名称',
  'team.add.title': '加成员',
  'team.memory.title': '团队记忆',
  'team.memory.empty': '还没有文件（建团时会自动生成 charter.md）。',
  'team.memory.loading': '加载中…',
  'team.memory.failed': '文件加载失败',
  'team.task.add': '添加',
  'team.task.newPlaceholder': '新任务标题…',
  'team.task.save': '保存',
  'team.task.saving': '保存中…',
  'team.task.status': '状态',
  'team.task.assignee': '负责人',
  'team.task.viewTimeline': '查看时间线',
  'team.task.createFailed': '任务创建失败',
  'team.task.statusLabel.todo': '待办',
  'team.task.statusLabel.doing': '进行中',
  'team.task.statusLabel.done': '完成',
  'team.task.statusLabel.blocked': '阻塞',
  'team.settings.title': '团队设置',
  'team.settings.rename': '重命名',
  'team.settings.archive': '归档团队（停止消息路由）',
  'team.settings.unarchive': '取消归档',
  'team.settings.delete': '删除团队…',
  'team.settings.deleteConfirm': '确定删除该团队？成员/任务/消息记录会被移除，成员的会话本身不受影响。',
  'team.settings.deleteConfirmYes': '删除',
  'team.archivedHint': '该团队已归档，在团队设置里取消归档即可恢复。',
  ...
  'team.settings.budget': '团队预算',
  'team.settings.budget.members': '成员上限',
  'team.settings.budget.messages': '消息/分钟',
  'team.settings.budget.chain': '链深',
  'team.settings.budgetHint': '成员上限包含 Lead；改动立即生效。',
  'team.member.remove': '移出团队',
  'team.member.removeConfirm': '确认把「{role}」移出团队？',
  'team.member.removeStopSession': '同时停止该会话',
  'team.member.removeConfirmYes': '确认移出',
  'team.member.removeFailed': '移出成员失败',
  ...
  'newSession.team.machineUnsupported': '这台机器的运行器版本过旧、不支持团队。请先升级该机器上的 HAPI CLI（或换一台机器），再创建团队会话。',
  'team.section.members': '{n} 名成员',
  'team.section.noMembers': '还没有成员',
  'newSession.member.banner': '将作为成员加入团队「{name}」',
  'newSession.member.role': '角色名称',
  'newSession.member.rolePlaceholder': '例如 Builder A / Reviewer',
