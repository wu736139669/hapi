export default {
  ...
  'team.create.title': '新建团队',
  'team.create.name': '团队名称',
  'team.create.namePlaceholder': '例如：重构认证模块',
  'team.create.lead': 'Lead 会话',
  'team.create.leadNone': '暂不指定 Lead',
  'team.create.leadHint': '选择一个已有会话作为团队 Lead，它负责派生成员和分派任务。',
  'team.create.noSessions': '还没有会话，请先创建一个会话。',
  'team.create.submit': '创建团队',
  'team.create.creating': '创建中…',
  'team.add.title': '加成员',
  'team.add.role': '角色名称',
  'team.add.rolePlaceholder': '例如 Builder A / Reviewer',
  'team.add.task': '任务说明（可选）',
  'team.add.taskPlaceholder': '这个成员一开始要做什么？',
  'team.add.yolo': '自主模式（跳过权限确认）',
  'team.add.submit': '派生成员',
  'team.add.spawning': '派生中…',
  'team.add.noLead': '该团队没有 Lead 会话，先设置 Lead 才能派生成员。',
  'team.add.success': '已派生 {role}',
  ...
  'team.add.agentDefault': '跟随 lead',
  'team.add.worktree': '独立 git worktree',
  'team.create.machine': '机器',
  'team.create.noMachines': '没有在线 runner',
  'team.create.agent': 'Agent',
  'team.create.directory': '目录',
  'team.create.directoryPlaceholder': '/Users/you/project',
  'team.create.directoryHint': 'Lead 会话将在这里启动；成员默认跟随同一机器与目录，勾选 worktree 可隔离文件改动。',
  'team.create.worktree': '为 Lead 使用独立 git worktree',
